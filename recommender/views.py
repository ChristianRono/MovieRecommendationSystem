...
from recommender.recommendations import load_recommendations,load_identical_movies
...
def detail(request, movie_id):
    ...
    movie_rec = load_identical_movies(movie_object,12)
    movie_ids = [movie_id for movie_title, movie_id in movie_rec]
    movie_rec = Movie.objects.filter(movie_id__in=movie_ids)
